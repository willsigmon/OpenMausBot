...
// connectedServices runs two upstream inventories. Ten pages each, plus the
// Session lookup, remains below the Workers Free external-subrequest budget;
// Composio caps Session toolkit pages at 50 items, so keep that valid page size.
const MAX_CONNECTED_ACCOUNT_PAGES = 10;
